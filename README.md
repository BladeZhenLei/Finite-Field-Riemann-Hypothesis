...
$[C]=\big\{{e_2}{e_3}{e_5}\big\},$
$[D]=\big\{{e_1}{e_2}{e_3}{e_4}\big\},$
and 
$[E]=\big\{${e_1}{e_2}{e_3}{e_4}{e_1}{e_{10}}{e_4}\big\}.$
Here, $e{_{10}}=e{{_5}^{-1}}$ is the backtracking, the path lengths are $v(C)=3$, $v(D)=4$, $v(E)=7$, respectively. 
